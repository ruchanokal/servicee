...
class ServiceSignUpFr : Fragment() {

    private var binding : FragmentServiceSignUpBinding? = null
    private lateinit var db : FirebaseFirestore
    private val TAG = "ServiceSignUpFr"
    ...
    override fun onCreateView(
        ...
        binding = FragmentServiceSignUpBinding.inflate(inflater,container,false)
    ...
    private fun databaseCollection() {
        ...
        reference = db.collection("Service")
        ...
        if (email.equals("")
            ...
            mAuth.createUserWithEmailAndPassword(email,sifre).addOnCompleteListener { task ->
                ...
                if (task.isSuccessful){
                    ...
                    val action = ServiceSignUpFrDirections.actionServiceSignUpFrToServisHizmetlerFragment(3,kullaniciAdi,email)
